...
function deriveDcfSignal(
  upside: number | null,
): 'UNDERVALUED' | 'FAIRLY VALUED' | 'OVERVALUED' | null {
...
export async function getStockSnapshot(
  ...
  // Rating section
  let ratingBlock: StockSnapshot['rating'] = null;
  if (rating) {
    ratingBlock = {
  ...
  const employees =
    employeesRaw !== undefined && employeesRaw !== null
